...
<head>
    ...
    <title>Maklumat KVSkills | KVSkills Hub</title>
...
<body>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="menu">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="../jurulatih/dashboard.php"> Jurulatih</a>
                    </li>
                
                    <li class="nav-item">
                        <a class="nav-link active" href="#">Maklumat KVSkills</a>
                    </li>
    ...
    <section class="container py-5">
        <div class="row g-4 justify-content-center">
            <div class="col-lg-5">
                <a href="lokasi.php" class="dashboard-card">
            ...
            <div class="col-lg-5">
                <a href="keputusan.php" class="dashboard-card">
            ...
            <div class="col-lg-5">
                <a href="peserta.php" class="dashboard-card">
            ...
            <div class="col-lg-5">
                <a href="logo.php" class="dashboard-card">
